                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="profilePicPreview logoPicPrev iconPrev" style="background-image: url({{ getImage(imagePath()['watermark']['path'] .'/watermark.png', '?'.time()) }})">
                                                        <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 mt-sm-0 mt-4">
                                                    <div class="profilePicPreview logoPicPrev iconPrev bg--dark" style="background-image: url({{ getImage(imagePath()['watermark']['path'] .'/watermark.png', '?'.time()) }})">
                                                        <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" class="profilePicUpload" id="profilePicUpload3" accept=".png" name="watermark">
                                            <label for="profilePicUpload3" class="bg-primary">@lang('Select Watermark')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
