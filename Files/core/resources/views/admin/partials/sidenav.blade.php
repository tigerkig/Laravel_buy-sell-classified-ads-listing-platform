                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.ads*',3)}}">
                       <i class="menu-icon lab la-buysellads"></i>
                        <span class="menu-title">@lang('Manage Credit List')</span>
                        @if($pending_ad > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item  {{menuActive('admin.ads')}}">
                                <a href="{{route('admin.ads')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Credits')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.ads.featured')}} ">
                                <a href="{{route('admin.ads.featured')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Featured Credits')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.ad.promote*',3)}}">
                       <i class="menu-icon las la-bullhorn"></i>
                        <span class="menu-title">@lang('Acquista Crediti Request')</span>
