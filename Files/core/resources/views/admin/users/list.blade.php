                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <th scope = "col">@lang('Doc_1')</th>
                                <th scope = "col">@lang('Doc_2')</th>
                                <th scope = "col">@lang('Doc_3')</th>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Username')">
                                    <a href="/{{ $user->pdf1_path }}" download>
                                        <?php
                                            $docname1 = $user->pdf1_name;
                                            echo $docname1;
                                        ?>
                                    </a>
                                </td>
                                <td data-label="@lang('Username')">
                                    <a href="/{{ $user->pdf2_path }}" download>
                                        <?php
                                            $docname2 = $user->pdf2_name;
                                            echo $docname2;
                                        ?>
                                    </a>
                                </td>
                                <td data-label="@lang('Username')">
                                    <a href="/{{ $user->pdf3_path }}" download>
                                        <?php
                                            $docname3 = $user->pdf3_name;
                                            echo $docname3;
                                        ?>
                                    </a>
                                </td>
