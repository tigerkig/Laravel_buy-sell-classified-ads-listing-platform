                ...
                <td data-label="@lang('Ad title')">
                  ...
                  <td data-label="@lang('Promote')">
                    ...
                    @elseif($ad->promoted())
                        @lang('Requested')
                    @else
                      <a href="{{route('user.promote.ad.packages',$ad->slug)}}" data-toggle="tooltip" title ="@lang('Promote this Credit')" class="icon-btn btn--success"><i class="las la-bullhorn"></i></a>
                    @endif
                  </td>
