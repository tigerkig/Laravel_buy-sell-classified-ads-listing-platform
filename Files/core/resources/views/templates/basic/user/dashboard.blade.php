              ...
              <tr>
                <td data-label="@lang('Ad title')">
                  <div class="table-item">
                    ...
                    <div class="content">
                      <h6 class="title"><a data-toggle="tooltip" title="{{$ad->title}}" target="_blank" href="{{route('ad.details',$ad->slug)}}">{{shortDescription($ad->title,50)}}</a></h6>
                    </div>
                  </div>
                </td>
                  ...
                  <td data-label="@lang('Promote')">
                    ...
                    @elseif($ad->promoted())
                        @lang('Requested')
                    @else
                      <a href="{{route('user.requestBuyCredit', $ad->id)}}" data-toggle="tooltip" title ="@lang('Promote this Credit')" class="icon-btn btn--success"><i class="las la-bullhorn"></i></a>
                    @endif
                  </td>
                ...
                @empty
                <tr><td colspan="12" class="text-center">@lang('No Credits')</td></tr>
              @endforelse
